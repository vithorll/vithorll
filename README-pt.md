...
**Desenvolvedor Full Stack em formação** · **Estudante de Informática no IFRS**

🇺🇸 [English](README.md)

Sou estudante do curso **Técnico em Informática para Internet** no Instituto Federal de Educação, Ciência e Tecnologia do Rio Grande do Sul (IFRS), atualmente focado em desenvolver minhas habilidades como Desenvolvedor Full Stack.
...
![Tecnologias](https://skillicons.dev/icons?i=html,css,js,react,nodejs,python,php)

### Bancos de Dados e Ferramentas de Desenvolvimento

![Tecnologias](https://skillicons.dev/icons?i=mysql,postgres,prisma,git,github,vscode)
...
**Bolsista na área de Tecnologia · 2024–2026**

Durante meu período no CITec, tive contato prático com diferentes áreas da tecnologia, incluindo:

* Suporte técnico
* Automação
* Programação e desenvolvimento de sistemas
* Educação tecnológica
* Robótica e fabricação digital
